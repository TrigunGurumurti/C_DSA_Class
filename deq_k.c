// Normal Queue :
// 1) FIFO
// 2)Allows insertion at the rear(end)
// 3)Allows deletion at the front(head)

// Applications :
// 1)Task scheduling
// 2)Handle the resources(memory,hardware,etc)

// 1)Priority Queues - Array and LL implementation
// 2)Circular Queues - Array and LL implementation

// -----------------------------------------------------------------------

// Dequeue : Double - Ended Queue
// A Dequeue allows insertion and deletion from both the ends(front,rear)
...
//     Insertion is allowed at one end(front or rear),deletion can happen at both the ends(front and rear)

// 2)Output - restricted dequeue
//     Deletion is allowed at one end(front or rear),insertion can happen at both the ends(front and rear)

// Applications :
// 1)Sliding window problem - Computer Networks
// 2)Palindrome checking
// 3)Job processing - requires both the ends

// Differences :
// Normal Queue :
// 1)Insertion is only at rear
// 2)Deletion is only from the front
// 3)FIFO behaviour is strictly followed
// 4)Operations:enqueue and dequeue
// 5)Task scheduling,printing queue

// Dequeue :
// 1)Insertion is at both the ends(rear,front)
// 2)Deletion is at both the ends(rear,front)
// 3)Does not strictly follow FIFO
// 4)Operations :
//     1)Insert_front() , 2)Insert_end() , 3)Delete_front() , 4)Delete_end() , 5)Sliding window , task prioritizing ,  Palindrome check
